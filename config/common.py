...
sql_base_path = f"{cwd}/data/test-sqls" # 应该是待执行的sql文件所在路径
...
db_name = f'{workload}_{data_size}G_{mode}_loftune' # e.g. 'TPCDS_100G_single_loftune'
loftune_db_url = f'mysql+mysqldb://{db_user}:{db_password}@{db_host}:{db_port}/{db_name}?charset=utf8' # 为什么这里检查的是本地MySQL数据库?
